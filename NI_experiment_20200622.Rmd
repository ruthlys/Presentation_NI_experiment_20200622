...
<p align="center">
  <img width="450" src="images/nitrification.png">
</p>
...
- Studies found varying effects on AOA and AOB gene abundance (*amoA* gene), AOA:AOB ratio and nitrification rates 
...
library(DT)
voc_table <- fread(file="/Users/ruthschmidt/Desktop/images/voc_table.txt")
DT::datatable(
  voc_table,
  rownames = FALSE,
...
- Effects of nitrification inhibitors might have far reaching but difficult to determine if shifts  caused directly (e.g. off-target toxic effects) or indirectly (through reduced activities of ammonia-oxidizers) 
